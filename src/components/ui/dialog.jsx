  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-White data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-[14px] sm:gap-[18px] md:gap-[22px] lg:gap-[26px] xl:gap-[29px] 2xl:gap-[32px] rounded-[20px] p-[28px] sm:p-[31px] md:p-[34px] lg:p-[37px] xl:p-[39px] 2xl:p-[40px] shadow-lg duration-200 shadow-[0px 9px 34px 0px #0000001A] ",
          className?.includes("pricing-dialog")
            ? "2xl:max-w-7xl xl:max-w-5xl lg:max-w-3xl max-w-lg max-h-[95vh] overflow-y-auto"
            : "sm:max-w-lg"
        )}
        {...props}>
        {children}
