                        ...
                        <tr className="border-y-[1.35px] border-[#D9D9D9] ">
                            ...
                            <td className="text-start px-[20px] py-[8px] sm:px-[23px] sm:py-[9px] md:px-[26px] md:py-[10px] lg:px-[29px] lg:py-[12px] xl:px-[31px] xl:py-[13px] 2xl:px-[32px] 2xl:py-[14px]">
                                <div className="flex flex-col gap-[4px] sm:gap-[5px] md:gap-[6.5px] lg:gap-[8px] xl:gap-[9px] 2xl:gap-[10px]">
                                    <span>
                                        <Paragraph size="tablecell" className="text-[#292929] font-medium">Loneliness</Paragraph>
                                    </span>
                                    <span>
                                        <Paragraph size="cellsubTitle" className="text-Gray500 font-inter">Stressor</Paragraph>
                                    </span>
                                </div>
                            </td>
                            ...
                            {/* 2 */}
                            <td className="">
                                <div className="flex flex-col gap-[4px] sm:gap-[5px] md:gap-[6.5px] lg:gap-[8px] xl:gap-[9px] 2xl:gap-[10px] items-center justify-center px-[20px] sm:px-[23px] md:px-[26px] lg:px-[29px] xl:px-[30.5px] 2xl:px-[32px]
">
                            ...
                            <td className="text-center">
                                <div className="flex flex-col items-start self-center w-max gap-[4px] sm:gap-[5px] md:gap-[6.5px] lg:gap-[8px] xl:gap-[9px] 2xl:gap-[10px] mx-auto px-[20px] sm:px-[23px] md:px-[26px] lg:px-[29px] xl:px-[30.5px] 2xl:px-[32px]
">
                            ...
                            {/* 4 */}
                            <td className="sticky right-0 bg-white z-5 text-right pr-[8px] md:pr-[15px]">
                                <Link href={`/dashboard/providers/patient/${patient.id}/check-ins`}>
